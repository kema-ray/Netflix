    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4)),
                ('category', models.CharField(choices=[('seasonal', 'seasonal'), ('single', 'single')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profiles', models.ManyToManyField(related_name='profiles', to='netflixapp.profile')),
